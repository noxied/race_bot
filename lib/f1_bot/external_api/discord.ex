defmodule F1Bot.ExternalApi.Discord do
  ...
  def default_emoji(:hard_tyre), do: "<:hard:1398564685871058976>"
  def default_emoji(:medium_tyre), do: "<:medium:1398564689281286245>"
  def default_emoji(:soft_tyre), do: "<:soft:1398564690682056724>"
  def default_emoji(:test_tyre), do: "<:f1_tyre_test:918870511801487420>"
  def default_emoji(:wet_tyre), do: "<:wet:1398564692481413181>"
  def default_emoji(:intermediate_tyre), do: "<:inter:1398564687779598369>"
  def default_emoji(:fastest_lap), do: "<:fastestLap:1398564432908390431>"
